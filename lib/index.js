      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.debug(_chalk["default"].blue(' Luisa Downloader - v. 1.0.9'));
            console.debug(_chalk["default"].blue('---------------------------------------'));
                    ...
                    return _regenerator["default"].wrap(function _callee7$(_context7) {
                      while (1) {
                        switch (_context7.prev = _context7.next) {
                          ...
                          case 6:
                            _context7.next = 8;
                            return optimizeImages(widgetsWithImages, fileFolderTarget);
...
function optimizeImages(_x10, _x11) {
  return _optimizeImages.apply(this, arguments);
}

function _optimizeImages() {
  _optimizeImages = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(images, fileFolderTarget) {
    var fileCheckSums, i, img, fileName, checkSum, _checkSum, filesWithSameChecksum, first, _i, other, _fileName;

    return _regenerator["default"].wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            console.debug(_chalk["default"].blue('Optimize images() image: ' + images.length));
            fileCheckSums = {};
            i = 0;
          ...
          case 3:
            ...
            img = images[i];
            fileName = fileFolderTarget + '/' + img.style.backgroundImage.url;
            _context9.next = 8;
            return createChecksum(fileName);

          case 8:
            checkSum = _context9.sent;
          ...
          case 13:
            for (_checkSum in fileCheckSums) {
              filesWithSameChecksum = fileCheckSums[_checkSum];

              if (filesWithSameChecksum.length > 1) {
                first = filesWithSameChecksum[0];
                /**
                 * Replace the background for all others and delete the files
                 */

                for (_i = 1; _i < filesWithSameChecksum.length; _i++) {
                  other = filesWithSameChecksum[_i];
                  _fileName = fileFolderTarget + '/' + other.style.backgroundImage.url;

                  _fs["default"].unlinkSync(_fileName);

                  other.style.backgroundImage = first.style.backgroundImage;
                  console.debug(_chalk["default"].blueBright('  -  Replace duplicate '), _chalk["default"].gray(_fileName));
                }
              }
            }
...
function createChecksum(path) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      var input = _fs["default"].createReadStream(path);
...
function ask_figma(_x12) {
  return _ask_figma.apply(this, arguments);
}

function _ask_figma() {
  _ask_figma = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(defaultConf) {
    var questions, answers;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            return _context10.abrupt("return", answers);
...
function _ask_save() {
  _ask_save = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11() {
    var questions, answers;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 3:
            ...
            return _context11.abrupt("return", answers.save === 'Yes, remember');
...
function ask_conf(_x13) {
  return _ask_conf.apply(this, arguments);
}

function _ask_conf() {
  _ask_conf = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(defaultConf) {
    var questions, answers;
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 3:
            ...
            return _context12.abrupt("return", answers);
